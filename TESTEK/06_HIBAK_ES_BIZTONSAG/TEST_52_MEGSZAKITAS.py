...
class TestCancellation(BaseTest):
    def test_remaining_items_can_be_marked_cancelled(self):
        states = ["done", "pending", "pending"]
        states = ["Megszakítva" if s == "pending" else s for s in states]
        self.assertEqual(states, ["done", "Megszakítva", "Megszakítva"])
