...
class TestPartialFailure(BaseTest):
    def test_failed_item_does_not_require_other_items_to_fail(self):
        results = ["Átmásolva", "Névütközés", "Átmásolva"]
        self.assertEqual(results.count("Átmásolva"), 2)
        self.assertEqual(results.count("Névütközés"), 1)
