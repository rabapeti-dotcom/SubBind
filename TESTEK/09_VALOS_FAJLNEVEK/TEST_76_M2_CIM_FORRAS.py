"""
M2: globális {CIM} csak kézi címnél — GUI/analyze regresszió.
"""
...
class TestM2CimForras(unittest.TestCase):
    def setUp(self):
        self.original_data = os.environ.get("SERIESRENAMER_DATA")
        self.data_dir = Path(tempfile.mkdtemp(prefix="sr_m2_data_"))
        self.out = Path(tempfile.mkdtemp(prefix="sr_m2_out_"))
        os.environ["SERIESRENAMER_DATA"] = str(self.data_dir)
        self.tmp = Path(tempfile.mkdtemp(prefix="sr_m2_"))
        self.win = MainWindow()
    ...
    def test_m2_3_manual_shared_title_acme(self):
        ...
        self.win.analyze()
        self.assertEqual(self.by_name("Murderbot").new_name, "Acme.S01E01.mkv")
        self.assertEqual(self.by_name("Invasion").new_name, "Acme.S01E01.srt")
    ...
    def test_m2_4_mixed_mode_keeps_own_titles(self):
        ...
        self.assertEqual(self.by_name("Invasion").new_name, "Invasion.S01E01.srt")
