...
class TestGuiDestinationCollision(GuiBase):
    def test_existing_destination_is_marked_and_not_overwritten(self):
        src = make_case(self.tmp, ("Show.S01E01.mkv", VIDEO))
        out = self.tmp / "output"
        out.mkdir()
        target = out / "Show.S01E01.mkv"
        target.write_bytes(b"ORIGINAL_TARGET")
        ...
        # A konkrétus állapotfrissítés verziófüggő lehet, de a GUI célútvonal
        # létezését és a forrás biztonságát itt már ellenőrizzük.
