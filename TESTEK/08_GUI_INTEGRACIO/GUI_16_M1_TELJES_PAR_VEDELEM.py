"""
M1.1 GUI: teljes pár + idegen hiányos group; klasszikus M1; M2 regresszió.
"""
...
class GuiBase(unittest.TestCase):
    def setUp(self):
        ...
        self.data_dir = Path(tempfile.mkdtemp(prefix="sr_gui_m11_data_"))
        self.out = Path(tempfile.mkdtemp(prefix="sr_gui_m11_out_"))
        os.environ["SERIESRENAMER_DATA"] = str(self.data_dir)
        self.tmp = Path(tempfile.mkdtemp(prefix="sr_gui_m11_"))
        self.win = MainWindow()
...
class TestM1TeljesParVedlem(GuiBase):
