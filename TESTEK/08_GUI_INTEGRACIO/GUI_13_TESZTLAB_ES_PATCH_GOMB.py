...
class TestGuiToolButtons(GuiBase):
    def test_testlab_and_patch_buttons_are_connected(self):
        self.assertTrue(self.win.test_lab_btn.isEnabled())
        self.assertTrue(self.win.patch_btn.isEnabled())
        self.assertEqual(self.win.test_lab_btn.text(), "Tesztlabor")
        self.assertEqual(self.win.patch_btn.text(), "Patch")
        self.assertTrue(callable(self.win.open_test_lab))
        self.assertTrue(callable(self.win.open_patch_center))
