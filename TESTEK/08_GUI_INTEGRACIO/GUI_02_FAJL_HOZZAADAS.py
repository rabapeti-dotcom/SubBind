...
class TestGuiFileAdd(GuiBase):
    def test_add_paths_loads_video_and_subtitle(self):
        ...
        self.assertEqual({i.kind for i in self.win.items}, {"video", "sub"})
        self.assertEqual(sum(i.lang == "hu" for i in self.win.items), 1)
