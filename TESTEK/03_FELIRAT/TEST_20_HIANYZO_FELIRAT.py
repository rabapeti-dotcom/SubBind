...
class TestMissingSubtitle(BaseTest):
    def test_video_without_subtitle_is_detectable(self):
        p = make_case(self.tmp, ("Show.S01E01.mkv", VIDEO)) / "Show.S01E01.mkv"
        self.assertEqual(parse(p).kind, "video")
        self.assertFalse((self.tmp / "Show.S01E01.hu.srt").exists())
