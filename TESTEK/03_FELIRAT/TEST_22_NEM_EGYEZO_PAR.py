...
class TestMismatchedPair(BaseTest):
    def test_different_episode_is_not_same_pair(self):
        make_case(self.tmp,
                  ("Show.S01E01.mkv", VIDEO),
                  ("Show.S01E02.hu.srt", SUB))
        v = parse(self.tmp / "Show.S01E01.mkv")
        s = parse(self.tmp / "Show.S01E02.hu.srt")
        self.assertNotEqual((v.season, v.episode), (s.season, s.episode))
