...
class TestSubtitleWithoutVideo(BaseTest):
    def test_subtitle_is_subtitle(self):
        p = make_case(self.tmp, ("Show.S01E01.hu.srt", SUB)) / "Show.S01E01.hu.srt"
        self.assertEqual(parse(p).kind, "sub")
