...
class TestMultipleEpisodes(BaseTest):
    def test_two_episode_numbers_are_distinct(self):
        make_case(self.tmp,
                  ("Sorozat.S01E01.mkv", VIDEO),
                  ("Sorozat.S01E02.mkv", VIDEO))
        a = parse(self.tmp / "Sorozat.S01E01.mkv")
        b = parse(self.tmp / "Sorozat.S01E02.mkv")
        self.assertEqual((a.season, a.episode), (1, 1))
        self.assertEqual((b.season, b.episode), (1, 2))
